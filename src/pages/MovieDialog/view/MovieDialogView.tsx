...
export const MovieDialogView: FunctionComponent<IMovieDialogParams> = (
  props: IMovieDialogParams,
) => {
  const {
    editMovie,
    dropdownHandler,
  ...
  if (deleteMovie) {
    return (
      <div
        className={styles.darkWrapper}
        onClick={() => setDialogOpenedHandler(false)}
      >
    ...
    >
      <div className={styles.formWrapper} onClick={clickFormHandler}>
        ...
        <form onSubmit={formik.handleSubmit} className={styles.form}>
          ...
          <div className={styles.row}>
            <label className={styles.inputLabel} htmlFor="release_date">
              release date
            </label>
            <input
              onChange={formik.handleChange}
          ...
          <div className={styles.row}>
            <label className={styles.inputLabel} htmlFor="poster_path">
              movie url
            </label>
            <input
              onChange={formik.handleChange}
            ...
            {formik.errors.poster_path ? (
              <div className={styles.error}>{formik.errors.poster_path}</div>
            ) : null}
          </div>

          <div className={styles.row}>
            <label className={styles.inputLabel} htmlFor="genres">
              genre
            </label>
          ...
          <div className={styles.row}>
            <label className={styles.inputLabel} htmlFor="overview">
              overview
            </label>
            <input
              onChange={formik.handleChange}
          ...
          <div className={styles.row}>
            <label className={styles.inputLabel} htmlFor="runtime">
              runtime
            </label>
            <input
              onChange={formik.handleChange}
